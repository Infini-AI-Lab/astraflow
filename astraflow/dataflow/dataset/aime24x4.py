...
def get_aime_2024_sft_dataset(
    tokenizer=None,
    max_length: int | None = None,
):
    """
    AIME-2024 is not intended for SFT training in this setup.
    """
    raise NotImplementedError("AIME-2024 dataset not supported for SFT training.")
...
def get_aime_2024x4_test_dataset(
    tokenizer=None,
    max_length: int | None = None,
    ...
    """
    Load the HuggingFaceH4/aime_2024 dataset and adapt it for RL-style evaluation.
    ...
    if offline_dir is not None:
        ...
        logger.info("Loading AIME-2024 dataset from offline path: %s", offline_dir)
        dataset = load_from_disk(offline_dir)
    else:
        logger.info("Loading AIME-2024 dataset from online source.")
...
if __name__ == "__main__":
    ...
    dataset = get_aime_2024x4_test_dataset(tokenizer=tokenizer, max_length=max_length)
