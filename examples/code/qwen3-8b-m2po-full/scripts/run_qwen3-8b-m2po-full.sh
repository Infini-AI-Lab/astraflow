#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 code training.
#
...
# Code-verify workspace (depends on LOG_DIR from astraflow_setup_env).
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-8B, code, M2PO, TCP full) ==="
...
echo "Verify tmp root     : ${ASTRAFLOW_VERIFY_WORK_ROOT}"
