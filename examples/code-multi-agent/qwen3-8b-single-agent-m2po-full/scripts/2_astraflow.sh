#!/bin/bash
set -euo pipefail
# [2/3] Launch AstraFlow HTTP service
#
# Usage (terminal 2, after RaaS is ready):
#   bash examples/code-multi-agent/qwen3-8b-single-agent-m2po-full/scripts/2_astraflow.sh
