#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 ASearcher training (Qwen2.5-7B-Instruct, SGLang, TCP full).
#
...
export TRIAL_NAME="${TRIAL_NAME:-qwen2.5-7b-instruct-m2po-full}"
...
echo "=== ASearcher AstraFlow v2 (Qwen2.5-7B-Instruct, SGLang, TCP full) ==="
