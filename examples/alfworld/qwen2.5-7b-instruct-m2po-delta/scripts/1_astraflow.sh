#!/bin/bash
set -euo pipefail
# [1/4] Launch AstraFlow HTTP service
#
# Usage (terminal, after 0_alfworld_server.sh is running):
#   bash examples/alfworld/qwen2.5-7b-instruct-m2po-delta/scripts/1_astraflow.sh
