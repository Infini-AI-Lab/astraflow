#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 math training (Qwen3-4B, M2PO, TCP).
#
...
export SERVICE_CUDA_VISIBLE_DEVICES="${SERVICE_CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5}"
export TRAINER_MODEL0_GPUS="${TRAINER_MODEL0_GPUS:-6,7}"
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-4B, math, M2PO, ctx16k, TCP) ==="
