#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 math training (Qwen3-8B, M2PO, TCP)
# using locally pre-downloaded math datasets (offline data mode).
#
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-8B, math, M2PO, ctx16k, TCP, OFFLINE DATA) ==="
