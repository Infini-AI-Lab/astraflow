#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 math training (Qwen3-8B, M2PO, TCP, LoRA).
#
...
#
# Usage:
#   bash examples/math/qwen3-8b-m2po-lora-lr5e-5/scripts/run_qwen3-8b-m2po-lora-lr5e-5.sh
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-8B, math, M2PO, ctx16k, TCP, LoRA) ==="
