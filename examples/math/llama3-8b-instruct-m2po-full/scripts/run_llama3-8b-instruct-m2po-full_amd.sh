#!/bin/bash
# AMD/ROCm launcher for the llama3-8b-instruct-m2po-full recipe (MI300/MI325, gfx942).
#
...
#   bash examples/math/llama3-8b-instruct-m2po-full/scripts/run_llama3-8b-instruct-m2po-full_amd.sh
# Under Slurm (pyxis-free; uses the node's docker daemon):
#   srun --gres=gpu:8 --nodes=1 --ntasks=1 bash examples/math/.../run_llama3-8b-instruct-m2po-full_amd.sh
#
# Env knobs:
...
bash examples/math/llama3-8b-instruct-m2po-full/scripts/run_llama3-8b-instruct-m2po-full.sh ${OVERRIDES[*]}
INNER_EOF
