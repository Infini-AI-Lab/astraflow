...
#
# Usage:
#   bash examples/math-efficient-data/qwen3-8b-m2po-full-replay05-greso/scripts/run_qwen3-8b-m2po-full-replay05-greso.sh
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-8B, math, M2PO, ctx16k, TCP) ==="
