#!/bin/bash
set -euo pipefail
# All-in-one launcher for AstraFlow v2 math training.
#
...
#
# Usage:
#   bash examples/math-multi-agent/qwen3-8b-single-agent-m2po-delta-deepscaler-data/scripts/run_qwen3-8b-single-agent-m2po-delta-deepscaler-data.sh
...
# =============================================================================
echo "=== AstraFlow v2 (Qwen3-8B single-agent, math-multi-agent, M2PO, ctx16k, TCP delta) ==="
